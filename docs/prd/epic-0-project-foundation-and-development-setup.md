...
- **Acceptance Criteria:**
  ...
  - ~~Production: AWS Systems Manager Parameter Store or AWS Secrets Manager for secure environment variable management~~ _OBSOLETE - See closure note_
  ...
  - ~~Production environment variables automatically injected into Lambda functions~~ _OBSOLETE - See closure note_
