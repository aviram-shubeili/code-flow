...
4. **FR4:** The system must integrate with Slack to send individual DM notifications for PR status changes and review outcomes
...
6. **FR6:** Slack notifications must use structured outcome messaging templates like "APPROVED - ready to merge", "3 comments need addressing", or "Changes requested with blocking issues"
...
10. **FR10:** Slack integration must require individual user consent and proper Slack OAuth authentication
...
4. **NFR4:** Slack integration must comply with Slack's security requirements and app approval process
